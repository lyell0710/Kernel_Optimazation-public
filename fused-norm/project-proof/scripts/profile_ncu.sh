#!/usr/bin/env bash
# 按版本分别采集 fused-norm 的 NCU 报告(.ncu-rep),供 ncu-ui 的 Add Baseline 做版本梯对比。
# 用法(在 fused-norm/ 下):
...
PROFILE_TARGETS=(
  "v0_add:v0_add_kernel"
  "v0_rmsnorm:v0_rmsnorm_kernel"
  "v1:v1_kernel"
  "v2:v2_kernel"
  "v3:v3_kernel"
  "v4:v4_kernel"
...
ncu_profile_all "$OUT_DIR" "fused_norm" PROFILE_TARGETS \
