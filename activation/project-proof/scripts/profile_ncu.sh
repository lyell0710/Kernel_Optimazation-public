#!/usr/bin/env bash
# 按版本分别采集 activation 的 NCU 报告(.ncu-rep),供 ncu-ui 的 Add Baseline 做版本梯对比。
# 用法(在 activation/ 下):
...
PROFILE_TARGETS=(
  "v0_silu:v0_silu_kernel"
  "v0_mul:v0_mul_kernel"
  "v1:v1_kernel"
  "v2:v2_kernel"
  "v3:v3_kernel"
)

ncu_profile_all "$OUT_DIR" "act" PROFILE_TARGETS \
